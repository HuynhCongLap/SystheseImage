...
public:
    ...
    void information(){
        std::cout<<"center: "<< m_center << " postion.x: "<< m_position.x << " position.y: "<<m_position.y ;
        std::cout<<" rotation.x: "<< m_rotation.x <<" rotation.y: " << m_rotation.y <<" size: "<< m_size ;
        std::cout<<" radius: "<< m_radius  ;
    }

    void up(Point center, float size, float angle ){
        m_center= center;
        //m_rotation.y = 180;
        //std::cout<<m_rotation.y<<"--";
        m_rotation.y = 180 - angle ;
        m_size= size;
        //m_rotation.x += 1;
    }
